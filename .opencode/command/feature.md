...
8. **Chỉ commit/push khi Reviewer PASS** + progress đã cập nhật, **chỉ tới `target_branch`**
...
10. Trước khi báo xong/đóng task/phase phải chạy **Doc Impact & Reconcile** trong `AGENTS.md` + `.agent/FEATURE_WORKFLOW.md`:
